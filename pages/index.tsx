      ...
      <Flex justifyContent="space-around">
        <Flex flexDir="column" p=" 0 20px 0 0">
          ...
          <Paragraph fontSize="xl" lineHeight={1.8}>
            ...
            solving problems and learning new things. Aside from programming and
            taking care of my child, I like to chill at the beach, wander
            through nature, and chat about topics like arts, music, history, and
            philosophy. I also like practicing and watching football and boxing.
